...
class IbmDbTestCase(unittest.TestCase):
    ...
    def run_test_000(self):
        ...
        for animal in animals:
            ...
            with open(
                os.path.dirname(os.path.abspath(__file__)) + "/" + animal[1], "rb"
            ) as fileHandle:
        ...
        if stmt:
            for photo in emp_photo:
                ...
                with open(
                    os.path.dirname(os.path.abspath(__file__)) + "/" + photo[2], "rb"
                ) as fileHandler:
        ...
        try:
            ...
            pass
        result = ibm_db.exec_immediate(
            conn, "CREATE TABLE t_string(a INTEGER, b DOUBLE PRECISION, c VARCHAR(100))"
        )
