    ...
    def run_test_231(self):
        ...
        for i in range(0, ibm_db.num_fields(result) + 1):
            print(
                str(i)
                + ":"
                + str(ibm_db.field_type(result, ibm_db.field_name(result, i)))
            )
        ...
        for i in range(0, ibm_db.num_fields(result2)):
            print(
                str(i) + ":" + ibm_db.field_type(result2, ibm_db.field_name(result2, i))
            )
        ...
        for i in range(0, 3):
            print(
                str(i) + ":" + ibm_db.field_type(result3, ibm_db.field_name(result3, i))
            )
