    ...
    def run_test_alltypesarray(self):
        ...
        if conn:
            ...
            if serverinfo.DBMS_NAME != "DSN12015":
                rc = ibm_db.set_option(
                    stmt,
                    {ibm_db.SQL_ATTR_PARAM_BIND_TYPE: ibm_db.SQL_PARAM_BIND_BY_COLUMN},
                    0,
                )
            ...
            arr16 = [
                b"1981-07-08 10:42:34.000010",
                b"1982-07-08 10:42:34.000010",
                b"1983-07-08 10:42:34.000010",
                b"1984-07-08 10:42:34.000010",
                b"1985-07-08 10:42:34.000010",
                b"1986-07-08 10:42:34.000010",
                b"1987-07-08 10:42:34.000010",
                b"1988-07-08 10:42:34.000010",
                b"1989-07-08 10:42:34.000010",
                b"1990-07-08 10:42:34.000010",
            ]
            arr17 = [
                b"To Test VarBinary1",
                b"To Test VarBinary2",
                b"To Test VarBinary3",
                b"To Test VarBinary4",
                b"To Test VarBinary5",
                b"To Test VarBinary6",
                b"To Test VarBinary7",
                b"To Test VarBinary8",
                b"To Test VarBinary9",
                b"To Test VarBinary10",
            ]
            arr18 = [
                b"To Test VARChar1",
                b"To Test VARChar2",
            ...
            arr20 = [
                datetime(1981, 2, 12, 23, 55, 59, 342380),
                datetime(1982, 2, 12, 23, 55, 59, 342380),
                datetime(1983, 2, 12, 23, 55, 59, 342380),
                datetime(1984, 2, 12, 23, 55, 59, 342380),
                datetime(1985, 2, 12, 23, 55, 59, 342380),
                datetime(1986, 2, 12, 23, 55, 59, 342380),
                datetime(1987, 2, 12, 23, 55, 59, 342380),
                datetime(1988, 2, 12, 23, 55, 59, 342380),
                datetime(1989, 2, 12, 23, 55, 59, 342380),
            ...
            arr26 = [
                "1981-07-08 10:42:34.000010",
                "1982-07-08 10:42:34.000010",
                "1983-07-08 10:42:34.000010",
                "1984-07-08 10:42:34.000010",
                "1985-07-08 10:42:34.000010",
                "1986-07-08 10:42:34.000010",
                "1987-07-08 10:42:34.000010",
                "1988-07-08 10:42:34.000010",
                "1989-07-08 10:42:34.000010",
                "1990-07-08 10:42:34.000010",
            ]
            arr27 = [
                "To Test VarBinary1",
                "To Test VarBinary2",
            ...
            try:
                if not serverinfo.DBMS_NAME.startswith("DB2/"):
                    ...
                    ibm_db.bind_param(
                        stmt, 13, arr16, ibm_db.SQL_PARAM_INPUT
                    )  # String Timestamp
                    ...
                    ibm_db.bind_param(
                        stmt, 21, arr26, ibm_db.SQL_PARAM_INPUT
                    )  # Unicode Timestamp
                    ...
                    ibm_db.bind_param(
                        stmt, 16, arr16, ibm_db.SQL_PARAM_INPUT
                    )  # String Timestamp
                    ...
                    ibm_db.bind_param(
                        stmt, 26, arr26, ibm_db.SQL_PARAM_INPUT
                    )  # Unicode Timestamp
