...
class IbmDbTestCase(unittest.TestCase):
    ...
    def run_test_err_executemany(self):
        ...
        if conn:
            ...
            insert_statement = (
                "INSERT INTO CLI0126E (position_id, title, type, quantity, price_btc, city, country)\
                                VALUES (?, ?, ?, ?, ?, ?, ?)"
            )
            ...
            parms2 = (
                15629,
                "incorrect value in row2 column4",
                "",
                99999999.0,
                0.0067762,
                "Belarus",
