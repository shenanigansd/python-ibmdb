        ...
        if conn:
            ...
            try:
                if not serverinfo.DBMS_NAME.startswith("DB2/"):
                    ...
                    ibm_db.bind_param(
                        stmt, 2, date(1982, 2, 12), ibm_db.SQL_PARAM_INPUT
                    )
                    ...
                    ibm_db.bind_param(
                        stmt, 9, b"To Test BINARY", ibm_db.SQL_PARAM_INPUT
                    )
                    ...
                    ibm_db.bind_param(
                        stmt, 13, b"1981-07-08 10:42:34.000010", ibm_db.SQL_PARAM_INPUT
                    )  # String Timestamp
                    ibm_db.bind_param(
                        stmt, 14, b"To Test VARChar", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 15, time(12, 35, 45), ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt,
                        16,
                    ...
                    ibm_db.bind_param(
                        stmt, 17, "To Test UniBINARY", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 18, "To Test UniBlob", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 19, "To Test UniChar", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 20, "To Test UniClob", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 21, "1981-07-08 10:42:34.000010", ibm_db.SQL_PARAM_INPUT
                    )  # Unicode Timestamp
                    ibm_db.bind_param(
                        stmt, 22, "To Test UniVARBINARY", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 23, "To Test UniVARChar", ibm_db.SQL_PARAM_INPUT
                    )
                else:
                    ibm_db.bind_param(stmt, 1, 870000, ibm_db.SQL_PARAM_INPUT)
                    ...
                    ibm_db.bind_param(
                        stmt, 4, date(1982, 2, 12), ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(stmt, 5, Decimal("8723"), ibm_db.SQL_PARAM_INPUT)
                    ...
                    ibm_db.bind_param(
                        stmt, 11, b"To Test BINARY", ibm_db.SQL_PARAM_INPUT
                    )
                    ...
                    ibm_db.bind_param(
                        stmt, 15, b"To Test DBClob", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 16, b"1981-07-08 10:42:34.000010", ibm_db.SQL_PARAM_INPUT
                    )  # String Timestamp
                    ibm_db.bind_param(
                        stmt, 17, b"To Test VARBINARY", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 18, b"To Test VARChar", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 19, time(12, 35, 45), ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt,
                        20,
                    ...
                    ibm_db.bind_param(
                        stmt, 21, "To Test UniBINARY", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 22, "To Test UniBlob", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 23, "To Test UniChar", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 24, "To Test UniClob", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 25, "To Test UniDBClob", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 26, "1981-07-08 10:42:34.000010", ibm_db.SQL_PARAM_INPUT
                    )  # Unicode Timestamp
                    ibm_db.bind_param(
                        stmt, 27, "To Test UniVARBINARY", ibm_db.SQL_PARAM_INPUT
                    )
                    ibm_db.bind_param(
                        stmt, 28, "To Test UniVARChar", ibm_db.SQL_PARAM_INPUT
                    )
